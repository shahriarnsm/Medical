  ...
  return (
    <div className='container mx-auto'>
      ...
      <div className='flex justify-around bg-purple-50 items-center py-5 mb-5 rounded-xl'>
        ...
        <div className='font-semibold text-2xl'>Total Price: {totalPrice}</div>

        <div><button  className='w-full md:w-auto text-white bg-red-600 px-4 py-4 rounded-xl md:mr-5 hover:bg-red-200 font-semibold hover:text-red-600'>Clear Cart</button>
        <button  className='w-full md:w-auto text-white bg-purple-600 px-4 py-4 rounded-xl md:mr-5 hover:bg-purple-200 font-semibold hover:text-purple-600'>Proceed Checkout</button></div>
